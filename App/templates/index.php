    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <h1 class="page-header">
                Главная страница:
                <small> три последние новости</small>
            </h1>

            <?php foreach ($news as $article) : ?>

            <h2>
                <a href="/blog/article/?id=<?php echo $article->id; ?>"><?php echo $article->title; ?></a>
                <br><br>
            ...
            <p><?php echo mb_substr($article->text, 0, 500).'...'; ?></p>
            <a class="btn btn-primary" href="/blog/article/?id=<?php echo $article->id; ?>">
